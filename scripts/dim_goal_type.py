...
from scripts.models import GoalType, GoalTypeSnap, Day
...
def dim_goal_type_load():
    ...
    return f"{counter} rows inserted successfully to DIM_GOAL_TYPE AND DIM_GOAL_TYPE_SNAP"
