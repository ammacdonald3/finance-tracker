...
from scripts.models import Category, CategorySnap, Day
...
def dim_category_load():
    ...
    return f"{counter} rows inserted successfully to DIM_CATEGORY and DIM_CATEGORY_SNAP"
