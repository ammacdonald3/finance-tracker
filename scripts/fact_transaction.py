...
from scripts.models import Account, AccountSnap, Payee, PayeeSnap, Category, CategorySnap, Day, Transaction, TransactionSnap
...
def fact_transaction_load():
    ...
    return f"{counter} rows inserted successfully to FACT_TRANSACTION and FACT_TRANSACTION_SNAP"
